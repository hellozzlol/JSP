...
.card .row .form-group input, .card .row .form-group textarea {
	position: absolute;
	width: 90%;
	height: 100%;
...
.card .row .form-group input:focus, .card .row .form-group textarea:focus
	{
	...
	<form>
		<div class="card">
			...
			<div class="row">
				...
				<div class="col">
					<div class="form-group">
						<label>사원이름</label> <input type="text">
					</div>
				</div>
